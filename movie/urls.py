...
from .views import post_Home, detail_movies, detail_category, error_404, random_movie, addLike,addDislike
...
urlpatterns = [
    ...
    url(r'^add_like/(?P<pk>\d+)/$', addLike, name="add_like"),
    url(r'^add_dislike/(?P<pk>\d+)/$', addDislike, name="add_dislike"),
